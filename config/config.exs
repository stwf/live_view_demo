...
config :live_view_demo, LiveViewDemoWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base:
    "dummy_val_for_dev_envdummy_val_for_dev_envdummy_val_for_dev_envdummy_val_for_dev_env",
  ...
  live_view: [
    signing_salt:
      "another_dummy_val_for_dev_envanother_dummy_val_for_dev_envanother_dummy_val_for_dev_envanother_dummy_val_for_dev_env"
  ]
